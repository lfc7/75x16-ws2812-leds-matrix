...
bool Parser::IsHexaDigit(byte item)
{
...
bool Parser::IsLowerCaseLetter(byte item)
{
	return item >= 'a' && item <= 'z';
}
...
bool Parser::IsUSITTSeparator(byte item)
{
	return item == ' ' || item == ',' || item == '/' || item == ';' || item == '<' || item == '=' || item == '>' || item == '@';
}

bool Parser::IsUSITTComment(byte item)
{
	return item == '!' || item == '$';
}

bool Parser::IsComment(byte item)
{
	return item == '#';
}
